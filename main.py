...
#     )
    ...
    # =============================================================================
# MAIN  (generates the figures)
# =============================================================================

# --- your existing yearly metrics, referenced here by name -------------------
# Assumes these already exist in your metrics module:
#   compute_yearly_sharpe(close), compute_yearly_drawdown_ratio(close)
# If you don't import them, the small fallbacks below keep this file runnable.
